...
const DocumentDefinitionPopover = ({
  ...
  return (
    <span
      className="absolute h-40 border border-gray-500 bg-white rounded-md left-0 transition-opacity duration-300 z-20 inline-block popover absolute-center cursor-pointer shadow-md"
